...
{
    var root = Path.Combine(Path.GetTempPath(), "apmc-core-path-test");
...
{
    var root = Path.Combine(Path.GetTempPath(), "apmc-case-test");
...
{
    var root = Path.Combine(Path.GetTempPath(), "apmc-fingerprint-" + Guid.NewGuid().ToString("N"));
    Directory.CreateDirectory(root);
    try
    {
